#ifndef CACHE_BENCHMARKS_NDARRAY_HPP
#define CACHE_BENCHMARKS_NDARRAY_HPP
...
public:
    ...
    [[nodiscard]] constexpr std::size_t shape(std::size_t i) const noexcept {
        return m_shape[i];
    }
...
#endif//CACHE_BENCHMARKS_NDARRAY_HPP
